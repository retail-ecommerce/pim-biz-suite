...
const addProduct = (targetObjectId, parameters) => {
  const url = `${PREFIX}catalogManager/addProduct/catalogId/displayName/parentCategoryId/brandId/origin/remark/tokensExpr/`
  const catalogId = targetObjectId
  const requestParameters = { ...parameters, catalogId, tokensExpr: 'none' }
  return postForm({ url,requestParameters})
}
...
const updateProduct = (targetObjectId, parameters) => {
  const url = `${PREFIX}catalogManager/updateProductProperties/catalogId/id/displayName/origin/remark/tokensExpr/`
  const catalogId = targetObjectId
  const requestParameters = { ...parameters, catalogId, tokensExpr: 'none' }
  return postForm({ url,requestParameters})
}

...
class CatalogPreference extends Component {
  ...
  render() {
    ...
    const { id,displayName, levelOneCategoryCount, productCount, newProductCount, editorPickProductCount, topRatedProductCount, recommandProductCount } = this.props.catalog

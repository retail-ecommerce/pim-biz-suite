...
const menuData = {menuName:"Editor Pick Product", menuFor: "editorPickProduct",
  		subItems: [
...
const EditorPickProductBase={menuData,displayColumns,fieldLabels}
export default EditorPickProductBase

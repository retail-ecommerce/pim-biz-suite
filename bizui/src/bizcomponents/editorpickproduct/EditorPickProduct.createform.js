...
import styles from './EditorPickProduct.createform.less'
...
class EditorPickProductCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addEditorPickProduct`,
          payload: { id: owner.id, type: 'editorPickProduct', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'editorPickProduct',listName:appLocaleName(userContext,"List") },
      })
    }
...
}))(Form.create()(EditorPickProductCreateForm))

...
import styles from './EditorPickProduct.updateform.less'
import EditorPickProductBase from './EditorPickProduct.base'
...
class EditorPickProductUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const {fieldLabels} = EditorPickProductBase
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const editorPickProductId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, editorPickProductId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateEditorPickProduct`,
          payload: {
            id: owner.id,
            type: 'editorPickProduct',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextEditorPickProductUpdateRow`,
        payload: {
          id: owner.id,
          type: 'editorPickProduct',
          selectedRows,
...
}))(Form.create()(EditorPickProductUpdateForm))

...
import styles from './TopRatedProduct.preference.less'
...
const internalImageListOf = (topRatedProduct) =>{
...
const internalSettingListOf = (topRatedProduct) =>{
	const userContext = null
	const optionList = [ 
	]
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = TopRatedProductService[candidateServiceName] 
...
const executeTrans = (topRatedProduct,targetComponent) =>{
...
const buildTransferModal = (topRatedProduct,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(topRatedProduct,targetComponent)}
...
const internalRenderExtraHeader = (topRatedProduct) =>{
	return null
}
const internalRenderExtraFooter = (topRatedProduct) =>{
	return null
}
...
<Description term="Parent Category">{topRatedProduct.parentCategory==null?appLocaleName(userContext,"NotAssigned"):topRatedProduct.parentCategory.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"Parent Category","levelNCategory","requestCandidateParentCategory",
	      "transferToAnotherParentCategory","anotherParentCategoryId",topRatedProduct.parentCategory?topRatedProduct.parentCategory.id:"")} 
...
<Description term="Brand">{topRatedProduct.brand==null?appLocaleName(userContext,"NotAssigned"):topRatedProduct.brand.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"Brand","brand","requestCandidateBrand",
	      "transferToAnotherBrand","anotherBrandId",topRatedProduct.brand?topRatedProduct.brand.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
...
<Description term="Catalog">{topRatedProduct.catalog==null?appLocaleName(userContext,"NotAssigned"):topRatedProduct.catalog.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"Catalog","catalog","requestCandidateCatalog",
	      "transferToAnotherCatalog","anotherCatalogId",topRatedProduct.catalog?topRatedProduct.catalog.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
...
<Description term="Profile">{topRatedProduct.profile==null?appLocaleName(userContext,"NotAssigned"):topRatedProduct.profile.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"Profile","profile","requestCandidateProfile",
	      "transferToAnotherProfile","anotherProfileId",topRatedProduct.profile?topRatedProduct.profile.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
...
const renderPermissionSetting = topRatedProduct => {
  const {TopRatedProductBase} = GlobalComponents
  return <PermissionSetting targetObject={topRatedProduct}  targetObjectMeta={TopRatedProductBase}/>


}


class TopRatedProductPreference extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"Top Rated Product",cardsFor: "topRatedProduct",cardsSource: this.props.topRatedProduct,
  		subItems: [
...
}))(Form.create()(TopRatedProductPreference))

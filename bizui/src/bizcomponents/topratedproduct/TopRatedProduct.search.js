...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{topRatedProductList:selectedRows}} owner={owner}  
...
class TopRatedProductSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {TopRatedProductTable} = GlobalComponents;
    const {TopRatedProductSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <TopRatedProductSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,TopRatedProductModalTable,"topRatedProductIds")}
...
export default Form.create()(TopRatedProductSearch)

...
import styles from './TopRatedProduct.createform.less'
...
class TopRatedProductCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const {fieldLabels} = TopRatedProductBase
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addTopRatedProduct`,
          payload: { id: owner.id, type: 'topRatedProduct', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'topRatedProduct',listName:appLocaleName(userContext,"List") },
      })
    }
...
}))(Form.create()(TopRatedProductCreateForm))

...
const menuData = {menuName:"Top Rated Product", menuFor: "topRatedProduct",
  		subItems: [
...
const TopRatedProductBase={menuData,displayColumns,fieldLabels}
export default TopRatedProductBase

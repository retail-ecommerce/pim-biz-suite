...
import styles from './TopRatedProduct.updateform.less'
...
class TopRatedProductUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const topRatedProductId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, topRatedProductId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateTopRatedProduct`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextTopRatedProductUpdateRow`,
        payload: {
          id: owner.id,
          type: 'topRatedProduct',
          selectedRows,
...
}))(Form.create()(TopRatedProductUpdateForm))

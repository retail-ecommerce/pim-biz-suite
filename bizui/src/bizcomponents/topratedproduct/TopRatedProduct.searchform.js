...
import styles from './TopRatedProduct.search.less'
...
class TopRatedProductSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      topRatedProductList: 1,
      'topRatedProductList.searchField': fieldName,
      'topRatedProductList.searchVerb': 'startsWith',
      'topRatedProductList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`topRatedProductList.searchField`] = fieldName
    value[`topRatedProductList.searchVerb`] =  searchVerb
    value[`topRatedProductList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['topRatedProductList'] = 1
      params['topRatedProductList.orderBy.0'] = "id"
      params['topRatedProductList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        topRatedProductSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={TopRatedProductService.requestCandidateParentCategory}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"brand"} 
                    requestFunction={TopRatedProductService.requestCandidateBrand}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"catalog"} 
                    requestFunction={TopRatedProductService.requestCandidateCatalog}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"profile"} 
                    requestFunction={TopRatedProductService.requestCandidateProfile}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={TopRatedProductService.requestCandidatePlatform}/>
...
export default Form.create()(TopRatedProductSearchForm)

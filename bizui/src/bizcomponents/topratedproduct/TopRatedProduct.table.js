...
class TopRatedProductTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
         ...
         { hasReadPermission(metaInfo)&&<Link to={`/topRatedProduct/${record.id}/dashboard`}>{appLocaleName(userContext,"View")}</Link>}
...
export default TopRatedProductTable

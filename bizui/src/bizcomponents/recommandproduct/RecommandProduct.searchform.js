...
import styles from './RecommandProduct.search.less'
...
class RecommandProductSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      recommandProductList: 1,
      'recommandProductList.searchField': fieldName,
      'recommandProductList.searchVerb': 'startsWith',
      'recommandProductList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`recommandProductList.searchField`] = fieldName
    value[`recommandProductList.searchVerb`] =  searchVerb
    value[`recommandProductList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['recommandProductList'] = 1
      params['recommandProductList.orderBy.0'] = "id"
      params['recommandProductList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        recommandProductSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RecommandProductSearchForm)

...
import styles from './RecommandProduct.updateform.less'
...
class RecommandProductUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const recommandProductId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, recommandProductId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRecommandProduct`,
          payload: {
            id: owner.id,
            type: 'recommandProduct',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRecommandProductUpdateRow`,
        payload: {
          id: owner.id,
          type: 'recommandProduct',
          selectedRows,
...
}))(Form.create()(RecommandProductUpdateForm))

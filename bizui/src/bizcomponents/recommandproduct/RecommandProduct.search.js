...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{recommandProductList:selectedRows}} owner={owner}  
...
class RecommandProductSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RecommandProductTable} = GlobalComponents;
    const {RecommandProductSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RecommandProductSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RecommandProductModalTable,"recommandProductIds")}
...
export default Form.create()(RecommandProductSearch)

...
class RecommandProductCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addRecommandProduct`,
          payload: { id: owner.id, type: 'recommandProduct', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'recommandProduct',listName:appLocaleName(userContext,"List") },
      })
    }
...
}))(Form.create()(RecommandProductCreateForm))

...
import styles from './CategoryFilter.search.less'
...
class CategoryFilterSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      categoryFilterList: 1,
      'categoryFilterList.searchField': fieldName,
      'categoryFilterList.searchVerb': 'startsWith',
      'categoryFilterList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`categoryFilterList.searchField`] = fieldName
    value[`categoryFilterList.searchVerb`] =  searchVerb
    value[`categoryFilterList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'internalId'))
      ...
      params['categoryFilterList'] = 1
      params['categoryFilterList.orderBy.0'] = "id"
      params['categoryFilterList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        categoryFilterSearchFormParameters: filterObjectKeys(fieldsValue),
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label="Internal Id">
              {getFieldDecorator('internalId')(
                <Input placeholder={appLocaleName(userContext,"PleaseInput")} />
              )}
            </FormItem>
          </Col>
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"profile"} 
                    requestFunction={CategoryFilterService.requestCandidateProfile}/>
...
export default Form.create()(CategoryFilterSearchForm)

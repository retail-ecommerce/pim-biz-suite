...
import styles from './CategoryFilter.updateform.less'
...
class CategoryFilterUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const categoryFilterId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, categoryFilterId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateCategoryFilter`,
          payload: {
            id: owner.id,
            type: 'categoryFilter',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextCategoryFilterUpdateRow`,
        payload: {
          id: owner.id,
          type: 'categoryFilter',
          selectedRows,
...
}))(Form.create()(CategoryFilterUpdateForm))

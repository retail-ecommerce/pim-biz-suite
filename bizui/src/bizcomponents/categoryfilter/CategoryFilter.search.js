...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{categoryFilterList:selectedRows}} owner={owner}  
...
class CategoryFilterSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {CategoryFilterTable} = GlobalComponents;
    const {CategoryFilterSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <CategoryFilterSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,CategoryFilterModalTable,"categoryFilterIds")}
...
export default Form.create()(CategoryFilterSearch)

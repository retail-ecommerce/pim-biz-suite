...
class ProfileDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const { id,displayName, brandFilterListMetaInfo, priceFilterListMetaInfo, categoryFilterListMetaInfo, newProductListMetaInfo, editorPickProductListMetaInfo, topRatedProductListMetaInfo, recommandProductListMetaInfo, brandFilterCount, priceFilterCount, categoryFilterCount, newProductCount, editorPickProductCount, topRatedProductCount, recommandProductCount } = this.props.profile

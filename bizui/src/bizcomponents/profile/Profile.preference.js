...
class ProfilePreference extends Component {
  ...
  render() {
    ...
    const { id,displayName, brandFilterCount, priceFilterCount, categoryFilterCount, newProductCount, editorPickProductCount, topRatedProductCount, recommandProductCount } = this.props.profile

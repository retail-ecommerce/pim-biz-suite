...
import styles from './PriceFilter.search.less'
...
class PriceFilterSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      priceFilterList: 1,
      'priceFilterList.searchField': fieldName,
      'priceFilterList.searchVerb': 'startsWith',
      'priceFilterList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`priceFilterList.searchField`] = fieldName
    value[`priceFilterList.searchVerb`] =  searchVerb
    value[`priceFilterList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['priceFilterList'] = 1
      params['priceFilterList.orderBy.0'] = "id"
      params['priceFilterList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        priceFilterSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(PriceFilterSearchForm)

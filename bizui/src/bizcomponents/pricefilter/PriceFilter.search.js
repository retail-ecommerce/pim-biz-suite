...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{priceFilterList:selectedRows}} owner={owner}  
...
class PriceFilterSearch extends PureComponent {
  ...
  render(){
    ...
    const {PriceFilterTable} = GlobalComponents;
    const {PriceFilterSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <PriceFilterSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,PriceFilterModalTable,"priceFilterIds")}
...
export default Form.create()(PriceFilterSearch)

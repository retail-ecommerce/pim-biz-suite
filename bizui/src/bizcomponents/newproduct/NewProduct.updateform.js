...
import styles from './NewProduct.updateform.less'
...
class NewProductUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const newProductId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, newProductId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateNewProduct`,
          payload: {
            id: owner.id,
            type: 'newProduct',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextNewProductUpdateRow`,
        payload: {
          id: owner.id,
          type: 'newProduct',
          selectedRows,
...
}))(Form.create()(NewProductUpdateForm))

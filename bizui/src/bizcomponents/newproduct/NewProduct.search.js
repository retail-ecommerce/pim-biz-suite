...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{newProductList:selectedRows}} owner={owner}  
...
class NewProductSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {NewProductTable} = GlobalComponents;
    const {NewProductSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <NewProductSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,NewProductModalTable,"newProductIds")}
...
export default Form.create()(NewProductSearch)

...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{brandFilterList:selectedRows}} owner={owner}  
...
class BrandFilterSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {BrandFilterTable} = GlobalComponents;
    const {BrandFilterSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <BrandFilterSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,BrandFilterModalTable,"brandFilterIds")}
...
export default Form.create()(BrandFilterSearch)

...
import styles from './BrandFilter.search.less'
...
class BrandFilterSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      brandFilterList: 1,
      'brandFilterList.searchField': fieldName,
      'brandFilterList.searchVerb': 'startsWith',
      'brandFilterList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`brandFilterList.searchField`] = fieldName
    value[`brandFilterList.searchVerb`] =  searchVerb
    value[`brandFilterList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['brandFilterList'] = 1
      params['brandFilterList.orderBy.0'] = "id"
      params['brandFilterList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        brandFilterSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"profile"} 
                    requestFunction={BrandFilterService.requestCandidateProfile}/>
...
export default Form.create()(BrandFilterSearchForm)

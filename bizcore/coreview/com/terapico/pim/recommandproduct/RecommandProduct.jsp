<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.recommandproduct.RecommandProduct'%>
...
<sky:include page="com/terapico/pim/recommandproduct/RecommandProduct$Summary.jsp" />

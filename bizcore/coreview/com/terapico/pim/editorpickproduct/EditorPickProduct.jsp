<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.editorpickproduct.EditorPickProduct'%>
...
<sky:include page="com/terapico/pim/editorpickproduct/EditorPickProduct$Summary.jsp" />
...
<sky:include page="com/terapico/pim/levelncategory/LevelNCategory$Info.jsp" />

<c:set var="brand" value="${ result.brand}" scope="request" />
<sky:include page="com/terapico/pim/brand/Brand$Info.jsp" />
...
<sky:include page="com/terapico/pim/profile/Profile$Info.jsp" />

<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/terapico/pim/secuserblocking/SecUserBlocking$Summary.jsp" />

<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/terapico/pim/userwhitelist/UserWhiteList$Summary.jsp" />

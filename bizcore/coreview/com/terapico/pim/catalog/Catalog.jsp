<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.catalog.Catalog'%>
...
<sky:include page="com/terapico/pim/catalog/Catalog$Summary.jsp" />
...
<sky:include page="com/terapico/pim/platform/Platform$Info.jsp" />
		...
		<div id="levelOneCategoryList" class="tab-pane fade sublist" refer-name="catalog">
			<sky:include page="com/terapico/pim/levelonecategory/LevelOneCategory$List.jsp"
					referName="catalog"/>
		</div>
	</c:if>

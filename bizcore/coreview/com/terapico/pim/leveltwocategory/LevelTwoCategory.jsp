<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.leveltwocategory.LevelTwoCategory'%>
...
<sky:include page="com/terapico/pim/leveltwocategory/LevelTwoCategory$Summary.jsp" />
...
<sky:include page="com/terapico/pim/levelonecategory/LevelOneCategory$Info.jsp" />
		...
		<div id="levelNCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<sky:include page="com/terapico/pim/levelncategory/LevelNCategory$List.jsp"

<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.product.Product'%>
...
<sky:include page="com/terapico/pim/product/Product$Summary.jsp" />
...
<sky:include page="com/terapico/pim/platform/Platform$Info.jsp" />
		...
		<div id="skuList" class="tab-pane fade sublist" refer-name="product">
			<sky:include page="com/terapico/pim/sku/Sku$List.jsp"
					referName="product"/>
		</div>
	</c:if>

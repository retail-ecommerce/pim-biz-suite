<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.categoryfilter.CategoryFilter'%>
...
<sky:include page="com/terapico/pim/categoryfilter/CategoryFilter$Summary.jsp" />

<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.loginhistory.LoginHistory'%>
...
<sky:include page="com/terapico/pim/loginhistory/LoginHistory$Summary.jsp" />

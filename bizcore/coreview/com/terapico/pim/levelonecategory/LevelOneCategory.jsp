<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.levelonecategory.LevelOneCategory'%>
...
<sky:include page="com/terapico/pim/levelonecategory/LevelOneCategory$Summary.jsp" />
...
<sky:include page="com/terapico/pim/catalog/Catalog$Info.jsp" />
		...
		<div id="levelTwoCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<sky:include page="com/terapico/pim/leveltwocategory/LevelTwoCategory$List.jsp"

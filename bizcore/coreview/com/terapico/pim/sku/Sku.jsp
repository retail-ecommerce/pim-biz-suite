<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.sku.Sku'%>
...
<sky:include page="com/terapico/pim/sku/Sku$Summary.jsp" />
...
<sky:include page="com/terapico/pim/product/Product$Info.jsp" />

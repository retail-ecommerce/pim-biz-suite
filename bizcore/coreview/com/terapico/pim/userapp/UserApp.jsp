<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.userapp.UserApp'%>
...
<sky:include page="com/terapico/pim/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/terapico/pim/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/terapico/pim/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/terapico/pim/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>

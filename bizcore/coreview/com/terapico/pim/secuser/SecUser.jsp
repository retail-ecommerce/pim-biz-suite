<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.secuser.SecUser'%>
...
<sky:include page="com/terapico/pim/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/terapico/pim/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/terapico/pim/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/terapico/pim/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/terapico/pim/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>

<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.objectaccess.ObjectAccess'%>
...
<sky:include page="com/terapico/pim/objectaccess/ObjectAccess$Summary.jsp" />
...
<sky:include page="com/terapico/pim/userapp/UserApp$Info.jsp" />

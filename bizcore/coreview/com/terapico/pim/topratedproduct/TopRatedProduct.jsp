<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.topratedproduct.TopRatedProduct'%>
...
<sky:include page="com/terapico/pim/topratedproduct/TopRatedProduct$Summary.jsp" />

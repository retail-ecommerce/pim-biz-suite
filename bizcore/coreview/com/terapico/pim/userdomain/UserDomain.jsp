<%@ page import='java.util.*,com.terapico.pim.*,com.terapico.pim.userdomain.UserDomain'%>
...
<sky:include page="com/terapico/pim/userdomain/UserDomain$Summary.jsp" />
		...
		<div id="userWhiteListList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/terapico/pim/userwhitelist/UserWhiteList$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/terapico/pim/secuser/SecUser$List.jsp"
					referName="domain"/>
		</div>
	</c:if>

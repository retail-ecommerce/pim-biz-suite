...
import com.terapico.pim.PimUserContextImpl;
import com.terapico.pim.LoginForm;
import com.terapico.pim.BaseEntity;
import com.terapico.pim.CommonError;
import com.terapico.pim.DAOGroup;
import com.terapico.pim.ManagerGroup;

import com.terapico.pim.UserContextImpl;
import com.terapico.pim.userapp.UserApp;
import com.terapico.pim.PimUserContext;
import com.terapico.pim.userapp.*;
import com.terapico.pim.listaccess.*;
import com.terapico.pim.objectaccess.*;
import com.terapico.pim.PimChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(PimUserContext userContext){
    ...
    public Object resetPassword(PimUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(PimUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(PimUserContext userContext,
    ...
    public SecUser manage(PimUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(PimUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(PimUserContext userContext) {
    ...
    protected Object gotoApp(PimUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(PimUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(PimUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(PimUserContext userContex, int length){
    ...
    protected String getBeanName(PimUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(PimUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(PimUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(PimUserContext userContext, UserApp app){
    ...
    public Object home(PimUserContext userContext) {
    ...
    public Object loginWithEmail(PimUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(PimUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(PimUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(PimUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(PimUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(PimUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(PimUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(PimUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(PimUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        PimUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected PimChecker checker;
    public PimChecker getChecker(){
        return checker;
    }
    
    public void setChecker(PimChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((PimChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected PimUserContextImpl createNewConext(String path) {

        return new PimUserContextImpl();
    ...
    public Object checkOtherLogin(PimUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(PimUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(PimUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(PimUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(PimUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(PimUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(PimUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){

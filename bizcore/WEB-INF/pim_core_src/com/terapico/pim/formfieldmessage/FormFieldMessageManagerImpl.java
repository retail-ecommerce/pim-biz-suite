...
import com.terapico.pim.genericform.CandidateGenericForm;
...
public class FormFieldMessageManagerImpl extends CustomPimCheckerManager implements FormFieldMessageManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldMessageManagerException{
 	...
 	protected FormFieldMessage saveFormFieldMessage(PimUserContext userContext, FormFieldMessage formFieldMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormFieldMessage saveFormFieldMessageDetail(PimUserContext userContext, FormFieldMessage formFieldMessage) throws Exception{	
 	...
 	public FormFieldMessage loadFormFieldMessage(PimUserContext userContext, String formFieldMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormFieldMessage searchFormFieldMessage(PimUserContext userContext, String formFieldMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormFieldMessage present(PimUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormFieldMessage loadFormFieldMessageDetail(PimUserContext userContext, String formFieldMessageId) throws Exception{	
 	...
 	public Object view(PimUserContext userContext, String formFieldMessageId) throws Exception{	
 		FormFieldMessage formFieldMessage = loadFormFieldMessage( userContext, formFieldMessageId, viewTokens());
 		return present(userContext,formFieldMessage, allTokens());
		
 	}
 	protected FormFieldMessage saveFormFieldMessage(PimUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldMessageDAO().save(formFieldMessage, tokens);
 	}
 	protected FormFieldMessage loadFormFieldMessage(PimUserContext userContext, String formFieldMessageId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormFieldMessage(formFieldMessageId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PimUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PimUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormFieldMessage(PimUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormFieldMessage clone(PimUserContext userContext, String fromFormFieldMessageId) throws Exception{
	...
	public FormFieldMessage internalSaveFormFieldMessage(PimUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object> options) throws Exception 
	{
	...
	public FormFieldMessage updateFormFieldMessageProperty(PimUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormFieldMessage(userContext, formFieldMessageId, formFieldMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(PimUserContext userContext, String formFieldMessageId, String anotherFormId) throws Exception
 	{
	...
	public CandidateGenericForm requestCandidateForm(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected GenericForm loadGenericForm(PimUserContext userContext, String newFormId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(PimUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
	...
	public FormFieldMessage forgetByAll(PimUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldMessageId, formFieldMessageVersion);		
	}
	protected FormFieldMessage forgetByAllInternal(PimUserContext userContext,
			String formFieldMessageId, int formFieldMessageVersion) throws Exception{

...
public class SecUserBlockingManagerImpl extends CustomPimCheckerManager implements SecUserBlockingManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserBlockingManagerException{
 	...
 	protected SecUserBlocking saveSecUserBlocking(PimUserContext userContext, SecUserBlocking secUserBlocking, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUserBlocking saveSecUserBlockingDetail(PimUserContext userContext, SecUserBlocking secUserBlocking) throws Exception{	
 	...
 	public SecUserBlocking loadSecUserBlocking(PimUserContext userContext, String secUserBlockingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUserBlocking searchSecUserBlocking(PimUserContext userContext, String secUserBlockingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUserBlocking present(PimUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUserBlocking loadSecUserBlockingDetail(PimUserContext userContext, String secUserBlockingId) throws Exception{	
 	...
 	public Object view(PimUserContext userContext, String secUserBlockingId) throws Exception{	
 		SecUserBlocking secUserBlocking = loadSecUserBlocking( userContext, secUserBlockingId, viewTokens());
 		return present(userContext,secUserBlocking, allTokens());
		
 	}
 	protected SecUserBlocking saveSecUserBlocking(PimUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getSecUserBlockingDAO().save(secUserBlocking, tokens);
 	}
 	protected SecUserBlocking loadSecUserBlocking(PimUserContext userContext, String secUserBlockingId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfSecUserBlocking(secUserBlockingId);
		userContext.getChecker().throwExceptionIfHasErrors( SecUserBlockingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PimUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PimUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUserBlocking(PimUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUserBlocking clone(PimUserContext userContext, String fromSecUserBlockingId) throws Exception{
	...
	public SecUserBlocking internalSaveSecUserBlocking(PimUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object> options) throws Exception 
	{
	...
	public SecUserBlocking updateSecUserBlockingProperty(PimUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUserBlocking(userContext, secUserBlockingId, secUserBlockingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(PimUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
	...
	public SecUserBlocking forgetByAll(PimUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserBlockingId, secUserBlockingVersion);		
	}
	protected SecUserBlocking forgetByAllInternal(PimUserContext userContext,
			String secUserBlockingId, int secUserBlockingVersion) throws Exception{
	...
	protected SecUserBlocking breakWithSecUserByDomain(PimUserContext userContext, String secUserBlockingId, String domainId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingSecUser(PimUserContext userContext, String secUserBlockingId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUserProperties(PimUserContext userContext, String secUserBlockingId,String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  SecUserBlocking updateSecUserProperties(PimUserContext userContext, String secUserBlockingId, String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(PimUserContext userContext, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(PimUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUserList(PimUserContext userContext, String secUserBlockingId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(PimUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUser(PimUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(PimUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking copySecUserFrom(PimUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(PimUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking updateSecUser(PimUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{

...
public class LevelTwoCategoryJDBCTemplateDAO extends PimNamingServiceDAO implements LevelTwoCategoryDAO{
	...
	*/
    ...
    public SmartList<LevelTwoCategory> requestCandidateLevelTwoCategoryForLevelNCategory(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {

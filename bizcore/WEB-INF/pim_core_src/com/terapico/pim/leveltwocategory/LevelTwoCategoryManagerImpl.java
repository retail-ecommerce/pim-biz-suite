...
import com.terapico.pim.levelonecategory.CandidateLevelOneCategory;
...
public class LevelTwoCategoryManagerImpl extends CustomPimCheckerManager implements LevelTwoCategoryManager {
	...
	protected void throwExceptionWithMessage(String value) throws LevelTwoCategoryManagerException{
 	...
 	protected LevelTwoCategory saveLevelTwoCategory(PimUserContext userContext, LevelTwoCategory levelTwoCategory, String [] tokensExpr) throws Exception{	
 	...
 	protected LevelTwoCategory saveLevelTwoCategoryDetail(PimUserContext userContext, LevelTwoCategory levelTwoCategory) throws Exception{	
 	...
 	public LevelTwoCategory loadLevelTwoCategory(PimUserContext userContext, String levelTwoCategoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LevelTwoCategory searchLevelTwoCategory(PimUserContext userContext, String levelTwoCategoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LevelTwoCategory present(PimUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String, Object> tokens) throws Exception {
 	...
 	public LevelTwoCategory loadLevelTwoCategoryDetail(PimUserContext userContext, String levelTwoCategoryId) throws Exception{	
 	...
 	public Object view(PimUserContext userContext, String levelTwoCategoryId) throws Exception{	
 		LevelTwoCategory levelTwoCategory = loadLevelTwoCategory( userContext, levelTwoCategoryId, viewTokens());
 		return present(userContext,levelTwoCategory, allTokens());
		
 	}
 	protected LevelTwoCategory saveLevelTwoCategory(PimUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getLevelTwoCategoryDAO().save(levelTwoCategory, tokens);
 	}
 	protected LevelTwoCategory loadLevelTwoCategory(PimUserContext userContext, String levelTwoCategoryId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfLevelTwoCategory(levelTwoCategoryId);
		userContext.getChecker().throwExceptionIfHasErrors( LevelTwoCategoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PimUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PimUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLevelTwoCategory(PimUserContext userContext,String levelTwoCategoryId, int levelTwoCategoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LevelTwoCategory clone(PimUserContext userContext, String fromLevelTwoCategoryId) throws Exception{
	...
	public LevelTwoCategory internalSaveLevelTwoCategory(PimUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String,Object> options) throws Exception 
	{
	...
	public LevelTwoCategory updateLevelTwoCategoryProperty(PimUserContext userContext,String levelTwoCategoryId, int levelTwoCategoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingLevelTwoCategory(userContext, levelTwoCategoryId, levelTwoCategoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherParentCategory(PimUserContext userContext, String levelTwoCategoryId, String anotherParentCategoryId) throws Exception
 	{
	...
	public CandidateLevelOneCategory requestCandidateParentCategory(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected LevelOneCategory loadLevelOneCategory(PimUserContext userContext, String newParentCategoryId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(PimUserContext userContext, String levelTwoCategoryId, int levelTwoCategoryVersion) throws Exception {
	...
	public LevelTwoCategory forgetByAll(PimUserContext userContext, String levelTwoCategoryId, int levelTwoCategoryVersion) throws Exception {
		return forgetByAllInternal(userContext, levelTwoCategoryId, levelTwoCategoryVersion);		
	}
	protected LevelTwoCategory forgetByAllInternal(PimUserContext userContext,
			String levelTwoCategoryId, int levelTwoCategoryVersion) throws Exception{
	...
	protected void checkParamsForRemovingLevelNCategoryList(PimUserContext userContext, String levelTwoCategoryId, 
	...
	public  LevelTwoCategory removeLevelNCategoryList(PimUserContext userContext, String levelTwoCategoryId, 
			String levelNCategoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLevelNCategory(PimUserContext userContext, String levelTwoCategoryId, 
	...
	public  LevelTwoCategory removeLevelNCategory(PimUserContext userContext, String levelTwoCategoryId, 
		String levelNCategoryId, int levelNCategoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLevelNCategory(PimUserContext userContext, String levelTwoCategoryId, 
		String levelNCategoryId, int levelNCategoryVersion,String [] tokensExpr) throws Exception{
	...
	public  LevelTwoCategory copyLevelNCategoryFrom(PimUserContext userContext, String levelTwoCategoryId, 
		String levelNCategoryId, int levelNCategoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelNCategory(PimUserContext userContext, String levelTwoCategoryId, String levelNCategoryId, int levelNCategoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  LevelTwoCategory updateLevelNCategory(PimUserContext userContext, String levelTwoCategoryId, String levelNCategoryId, int levelNCategoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{

...
import com.terapico.pim.secuser.SecUserCustomManagerImpl;
...
public class PimUserContextImpl extends UserContextImpl implements PimUserContext{
	...
	static final String RESOURCE_PATH="com.terapico.pim.PimResources";
	static final String CUSTOM_RESOURCE_PATH="com.terapico.pim.PimCustomResources";
    ...
    /*
    public static SecUser getSecUser(PimUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(PimUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(PimUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(PimUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();

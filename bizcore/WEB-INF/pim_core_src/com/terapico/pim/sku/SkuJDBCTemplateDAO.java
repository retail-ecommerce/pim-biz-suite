...
public class SkuJDBCTemplateDAO extends PimNamingServiceDAO implements SkuDAO{
	...
	protected Sku loadInternalSku(AccessKey accessKey, Map<String,Object> loadOptions) throws Exception{
 	...
 	public void analyzeSkuByProduct(SmartList<Sku> resultList, String productId, Map<String,Object> options){
		if(resultList==null){
 		...
 		filterKey.put(Sku.PRODUCT_PROPERTY, productId);
		...
		//Sku.LAST_UPDATE_TIME_PROPERTY
		lastUpdateTimeStatsItem.setDisplayName("Sku");
		lastUpdateTimeStatsItem.setInternalName(formatKeyForDateLine(Sku.LAST_UPDATE_TIME_PROPERTY));
		lastUpdateTimeStatsItem.setResult(statsWithGroup(DateKey.class,wrapWithDate(Sku.LAST_UPDATE_TIME_PROPERTY),filterKey,emptyOptions));

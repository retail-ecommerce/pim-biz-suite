...
public class Sku extends BaseEntity implements  java.io.Serializable{
	...
	public 	Sku(String displayName, String size, Product product, boolean active, BigDecimal basePrice, DateTime lastUpdateTime)
	{
	...
	public Sku updateLastUpdateTime(DateTime lastUpdateTime){
		this.mLastUpdateTime = lastUpdateTime;;
		this.changed = true;
		return this;
	}

...
public class UserDomainManagerImpl extends CustomPimCheckerManager implements UserDomainManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserDomainManagerException{
 	...
 	protected UserDomain saveUserDomain(PimUserContext userContext, UserDomain userDomain, String [] tokensExpr) throws Exception{	
 	...
 	protected UserDomain saveUserDomainDetail(PimUserContext userContext, UserDomain userDomain) throws Exception{	
 	...
 	public UserDomain loadUserDomain(PimUserContext userContext, String userDomainId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserDomain searchUserDomain(PimUserContext userContext, String userDomainId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserDomain present(PimUserContext userContext, UserDomain userDomain, Map<String, Object> tokens) throws Exception {
 	...
 	public UserDomain loadUserDomainDetail(PimUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, allTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	
 	public Object view(PimUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, viewTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	protected UserDomain saveUserDomain(PimUserContext userContext, UserDomain userDomain, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserDomainDAO().save(userDomain, tokens);
 	}
 	protected UserDomain loadUserDomain(PimUserContext userContext, String userDomainId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserDomain(userDomainId);
		userContext.getChecker().throwExceptionIfHasErrors( UserDomainManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PimUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PimUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserDomain(PimUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserDomain clone(PimUserContext userContext, String fromUserDomainId) throws Exception{
	...
	public UserDomain internalSaveUserDomain(PimUserContext userContext, UserDomain userDomain, Map<String,Object> options) throws Exception 
	{
	...
	public UserDomain updateUserDomainProperty(PimUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserDomain(userContext, userDomainId, userDomainVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(PimUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
	...
	public UserDomain forgetByAll(PimUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
		return forgetByAllInternal(userContext, userDomainId, userDomainVersion);		
	}
	protected UserDomain forgetByAllInternal(PimUserContext userContext,
			String userDomainId, int userDomainVersion) throws Exception{
	...
	protected void checkParamsForAddingUserWhiteList(PimUserContext userContext, String userDomainId, String userIdentity, String userSpecialFunctions,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteListProperties(PimUserContext userContext, String userDomainId,String id,String userIdentity,String userSpecialFunctions,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateUserWhiteListProperties(PimUserContext userContext, String userDomainId, String id,String userIdentity,String userSpecialFunctions, String [] tokensExpr) throws Exception
	{	
	...
	protected UserWhiteList createUserWhiteList(PimUserContext userContext, String userIdentity, String userSpecialFunctions) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteListList(PimUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteListList(PimUserContext userContext, String userDomainId, 
			String userWhiteListIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteList(PimUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteList(PimUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserWhiteList(PimUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copyUserWhiteListFrom(PimUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteList(PimUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateUserWhiteList(PimUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSecUser(PimUserContext userContext, String userDomainId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUserProperties(PimUserContext userContext, String userDomainId,String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateSecUserProperties(PimUserContext userContext, String userDomainId, String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(PimUserContext userContext, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(PimUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUserList(PimUserContext userContext, String userDomainId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(PimUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUser(PimUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(PimUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copySecUserFrom(PimUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(PimUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateSecUser(PimUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{

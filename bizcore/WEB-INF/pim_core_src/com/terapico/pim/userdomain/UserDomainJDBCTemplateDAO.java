...
public class UserDomainJDBCTemplateDAO extends PimNamingServiceDAO implements UserDomainDAO{
	...
	*/
    ...
    public SmartList<UserDomain> requestCandidateUserDomainForUserWhiteList(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<UserDomain> requestCandidateUserDomainForSecUser(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(UserDomainTable.COLUMN_NAME, filterKey, pageNo, pageSize, getUserDomainMapper());
    }

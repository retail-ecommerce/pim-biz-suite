...
public class GenericFormManagerImpl extends CustomPimCheckerManager implements GenericFormManager {
	...
	protected void throwExceptionWithMessage(String value) throws GenericFormManagerException{
 	...
 	protected GenericForm saveGenericForm(PimUserContext userContext, GenericForm genericForm, String [] tokensExpr) throws Exception{	
 	...
 	protected GenericForm saveGenericFormDetail(PimUserContext userContext, GenericForm genericForm) throws Exception{	
 	...
 	public GenericForm loadGenericForm(PimUserContext userContext, String genericFormId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GenericForm searchGenericForm(PimUserContext userContext, String genericFormId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GenericForm present(PimUserContext userContext, GenericForm genericForm, Map<String, Object> tokens) throws Exception {
 	...
 	public GenericForm loadGenericFormDetail(PimUserContext userContext, String genericFormId) throws Exception{	
 	...
 	public Object view(PimUserContext userContext, String genericFormId) throws Exception{	
 		GenericForm genericForm = loadGenericForm( userContext, genericFormId, viewTokens());
 		return present(userContext,genericForm, allTokens());
		
 	}
 	protected GenericForm saveGenericForm(PimUserContext userContext, GenericForm genericForm, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getGenericFormDAO().save(genericForm, tokens);
 	}
 	protected GenericForm loadGenericForm(PimUserContext userContext, String genericFormId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfGenericForm(genericFormId);
		userContext.getChecker().throwExceptionIfHasErrors( GenericFormManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PimUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PimUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGenericForm(PimUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GenericForm clone(PimUserContext userContext, String fromGenericFormId) throws Exception{
	...
	public GenericForm internalSaveGenericForm(PimUserContext userContext, GenericForm genericForm, Map<String,Object> options) throws Exception 
	{
	...
	public GenericForm updateGenericFormProperty(PimUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingGenericForm(userContext, genericFormId, genericFormVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(PimUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
	...
	public GenericForm forgetByAll(PimUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
		return forgetByAllInternal(userContext, genericFormId, genericFormVersion);		
	}
	protected GenericForm forgetByAllInternal(PimUserContext userContext,
			String genericFormId, int genericFormVersion) throws Exception{
	...
	protected void checkParamsForAddingFormMessage(PimUserContext userContext, String genericFormId, String title, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessageProperties(PimUserContext userContext, String genericFormId,String id,String title,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormMessageProperties(PimUserContext userContext, String genericFormId, String id,String title,String level, String [] tokensExpr) throws Exception
	{	
	...
	protected FormMessage createFormMessage(PimUserContext userContext, String title, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormMessageList(PimUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormMessageList(PimUserContext userContext, String genericFormId, 
			String formMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormMessage(PimUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormMessage(PimUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormMessage(PimUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormMessageFrom(PimUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessage(PimUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormMessage(PimUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormFieldMessage(PimUserContext userContext, String genericFormId, String title, String parameterName, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessageProperties(PimUserContext userContext, String genericFormId,String id,String title,String parameterName,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormFieldMessageProperties(PimUserContext userContext, String genericFormId, String id,String title,String parameterName,String level, String [] tokensExpr) throws Exception
	{	
	...
	protected FormFieldMessage createFormFieldMessage(PimUserContext userContext, String title, String parameterName, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessageList(PimUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldMessageList(PimUserContext userContext, String genericFormId, 
			String formFieldMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessage(PimUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldMessage(PimUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormFieldMessage(PimUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldMessageFrom(PimUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessage(PimUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormFieldMessage(PimUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	public  GenericForm updateFormFieldProperties(PimUserContext userContext, String genericFormId, String id,String label,String localeKey,String parameterName,String type,String placeholder,String defaultValue,String description,String fieldGroup,String minimumValue,String maximumValue,boolean required,boolean disabled,boolean customRendering,String candidateValues,String suggestValues, String [] tokensExpr) throws Exception
	{	
	...
	protected FormField createFormField(PimUserContext userContext, String label, String localeKey, String parameterName, String type, String placeholder, String defaultValue, String description, String fieldGroup, String minimumValue, String maximumValue, boolean required, boolean disabled, boolean customRendering, String candidateValues, String suggestValues) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldList(PimUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldList(PimUserContext userContext, String genericFormId, 
			String formFieldIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormField(PimUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormField(PimUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormField(PimUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldFrom(PimUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormField(PimUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormField(PimUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormAction(PimUserContext userContext, String genericFormId, String label, String localeKey, String actionKey, String level, String url,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormActionProperties(PimUserContext userContext, String genericFormId,String id,String label,String localeKey,String actionKey,String level,String url,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormActionProperties(PimUserContext userContext, String genericFormId, String id,String label,String localeKey,String actionKey,String level,String url, String [] tokensExpr) throws Exception
	{	
	...
	protected FormAction createFormAction(PimUserContext userContext, String label, String localeKey, String actionKey, String level, String url) throws Exception{
	...
	protected void checkParamsForRemovingFormActionList(PimUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormActionList(PimUserContext userContext, String genericFormId, 
			String formActionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormAction(PimUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormAction(PimUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormAction(PimUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormActionFrom(PimUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormAction(PimUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormAction(PimUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{

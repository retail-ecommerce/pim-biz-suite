...
public class GenericFormJDBCTemplateDAO extends PimNamingServiceDAO implements GenericFormDAO{
	...
	*/
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormMessage(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormFieldMessage(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormField(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormAction(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }

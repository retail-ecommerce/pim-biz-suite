...
public class FormActionManagerImpl extends CustomPimCheckerManager implements FormActionManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormActionManagerException{
 	...
 	protected FormAction saveFormAction(PimUserContext userContext, FormAction formAction, String [] tokensExpr) throws Exception{	
 	...
 	protected FormAction saveFormActionDetail(PimUserContext userContext, FormAction formAction) throws Exception{	
 	...
 	public FormAction loadFormAction(PimUserContext userContext, String formActionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormAction searchFormAction(PimUserContext userContext, String formActionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormAction present(PimUserContext userContext, FormAction formAction, Map<String, Object> tokens) throws Exception {
 	...
 	public FormAction loadFormActionDetail(PimUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, allTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	
 	public Object view(PimUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, viewTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	protected FormAction saveFormAction(PimUserContext userContext, FormAction formAction, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormActionDAO().save(formAction, tokens);
 	}
 	protected FormAction loadFormAction(PimUserContext userContext, String formActionId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormAction(formActionId);
		userContext.getChecker().throwExceptionIfHasErrors( FormActionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PimUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PimUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormAction(PimUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormAction clone(PimUserContext userContext, String fromFormActionId) throws Exception{
	...
	public FormAction internalSaveFormAction(PimUserContext userContext, FormAction formAction, Map<String,Object> options) throws Exception 
	{
	...
	public FormAction updateFormActionProperty(PimUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormAction(userContext, formActionId, formActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(PimUserContext userContext, String formActionId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(PimUserContext userContext, String formActionId, int formActionVersion) throws Exception {
	...
	public FormAction forgetByAll(PimUserContext userContext, String formActionId, int formActionVersion) throws Exception {
		return forgetByAllInternal(userContext, formActionId, formActionVersion);		
	}
	protected FormAction forgetByAllInternal(PimUserContext userContext,
			String formActionId, int formActionVersion) throws Exception{

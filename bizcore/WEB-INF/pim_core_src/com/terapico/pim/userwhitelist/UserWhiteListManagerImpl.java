...
public class UserWhiteListManagerImpl extends CustomPimCheckerManager implements UserWhiteListManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserWhiteListManagerException{
 	...
 	protected UserWhiteList saveUserWhiteList(PimUserContext userContext, UserWhiteList userWhiteList, String [] tokensExpr) throws Exception{	
 	...
 	protected UserWhiteList saveUserWhiteListDetail(PimUserContext userContext, UserWhiteList userWhiteList) throws Exception{	
 	...
 	public UserWhiteList loadUserWhiteList(PimUserContext userContext, String userWhiteListId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserWhiteList searchUserWhiteList(PimUserContext userContext, String userWhiteListId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserWhiteList present(PimUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens) throws Exception {
 	...
 	public UserWhiteList loadUserWhiteListDetail(PimUserContext userContext, String userWhiteListId) throws Exception{	
 	...
 	public Object view(PimUserContext userContext, String userWhiteListId) throws Exception{	
 		UserWhiteList userWhiteList = loadUserWhiteList( userContext, userWhiteListId, viewTokens());
 		return present(userContext,userWhiteList, allTokens());
		
 	}
 	protected UserWhiteList saveUserWhiteList(PimUserContext userContext, UserWhiteList userWhiteList, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserWhiteListDAO().save(userWhiteList, tokens);
 	}
 	protected UserWhiteList loadUserWhiteList(PimUserContext userContext, String userWhiteListId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserWhiteList(userWhiteListId);
		userContext.getChecker().throwExceptionIfHasErrors( UserWhiteListManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PimUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PimUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserWhiteList(PimUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserWhiteList clone(PimUserContext userContext, String fromUserWhiteListId) throws Exception{
	...
	public UserWhiteList internalSaveUserWhiteList(PimUserContext userContext, UserWhiteList userWhiteList, Map<String,Object> options) throws Exception 
	{
	...
	public UserWhiteList updateUserWhiteListProperty(PimUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserWhiteList(userContext, userWhiteListId, userWhiteListVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(PimUserContext userContext, String userWhiteListId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(PimUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
	...
	public UserWhiteList forgetByAll(PimUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
		return forgetByAllInternal(userContext, userWhiteListId, userWhiteListVersion);		
	}
	protected UserWhiteList forgetByAllInternal(PimUserContext userContext,
			String userWhiteListId, int userWhiteListVersion) throws Exception{

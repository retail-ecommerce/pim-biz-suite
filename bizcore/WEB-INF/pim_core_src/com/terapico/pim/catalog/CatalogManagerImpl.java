...
public class CatalogManagerImpl extends CustomPimCheckerManager implements CatalogManager {
 ...
 //--------------------------------------------------------------
	...
	protected void checkParamsForAddingLevelOneCategory(PimUserContext userContext, String catalogId, String displayName,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelOneCategoryProperties(PimUserContext userContext, String catalogId,String id,String displayName,String [] tokensExpr) throws Exception {
	...
	public  Catalog updateLevelOneCategoryProperties(PimUserContext userContext, String catalogId, String id,String displayName, String [] tokensExpr) throws Exception
	{	
	...
	protected LevelOneCategory createLevelOneCategory(PimUserContext userContext, String displayName) throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingProduct(PimUserContext userContext, String catalogId, String displayName, String parentCategoryId, String brandId, String origin, String remark,String [] tokensExpr) throws Exception{
	...
	{	
		...
		checkParamsForAddingProduct(userContext,catalogId,displayName, parentCategoryId, brandId, origin, remark,tokensExpr);
		
		Product product = createProduct(userContext,displayName, parentCategoryId, brandId, origin, remark);
	...
	protected void checkParamsForUpdatingProductProperties(PimUserContext userContext, String catalogId,String id,String displayName,String origin,String remark,String [] tokensExpr) throws Exception {
	...
	public  Catalog updateProductProperties(PimUserContext userContext, String catalogId, String id,String displayName,String origin,String remark, String [] tokensExpr) throws Exception
	{	
		checkParamsForUpdatingProductProperties(userContext,catalogId,id,displayName,origin,remark,tokensExpr);
	...
	protected Product createProduct(PimUserContext userContext, String displayName, String parentCategoryId, String brandId, String origin, String remark) throws Exception{

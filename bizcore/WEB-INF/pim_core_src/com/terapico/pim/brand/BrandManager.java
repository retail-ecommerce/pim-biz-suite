...
public interface BrandManager{
	...
	//public  ProductManager getProductManager(PimUserContext userContext, String brandId, String displayName, String parentCategoryId, String origin, String catalogId, String remark ,String [] tokensExpr)  throws Exception;

...
public class LevelOneCategoryJDBCTemplateDAO extends PimNamingServiceDAO implements LevelOneCategoryDAO{
	...
	*/
    ...
    public SmartList<LevelOneCategory> requestCandidateLevelOneCategoryForLevelTwoCategory(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {

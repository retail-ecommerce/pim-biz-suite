...
public class PimExceptionJsonSerializer extends  JsonSerializer<PimException> {
	...
	@Override
	public void serialize(PimException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, PimException exception,
	...
	protected void writeStartObject(PimException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(PimException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,PimException exception,
	...
	protected void writeMessageList(String fieldName,PimException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null

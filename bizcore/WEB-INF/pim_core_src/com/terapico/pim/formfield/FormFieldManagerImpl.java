...
public class FormFieldManagerImpl extends CustomPimCheckerManager implements FormFieldManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldManagerException{
 	...
 	protected FormField saveFormField(PimUserContext userContext, FormField formField, String [] tokensExpr) throws Exception{	
 	...
 	protected FormField saveFormFieldDetail(PimUserContext userContext, FormField formField) throws Exception{	
 	...
 	public FormField loadFormField(PimUserContext userContext, String formFieldId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormField searchFormField(PimUserContext userContext, String formFieldId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormField present(PimUserContext userContext, FormField formField, Map<String, Object> tokens) throws Exception {
 	...
 	public FormField loadFormFieldDetail(PimUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, allTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	
 	public Object view(PimUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, viewTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	protected FormField saveFormField(PimUserContext userContext, FormField formField, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldDAO().save(formField, tokens);
 	}
 	protected FormField loadFormField(PimUserContext userContext, String formFieldId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormField(formFieldId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PimUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PimUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormField(PimUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormField clone(PimUserContext userContext, String fromFormFieldId) throws Exception{
	...
	public FormField internalSaveFormField(PimUserContext userContext, FormField formField, Map<String,Object> options) throws Exception 
	{
	...
	public FormField updateFormFieldProperty(PimUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormField(userContext, formFieldId, formFieldVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(PimUserContext userContext, String formFieldId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(PimUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
	...
	public FormField forgetByAll(PimUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldId, formFieldVersion);		
	}
	protected FormField forgetByAllInternal(PimUserContext userContext,
			String formFieldId, int formFieldVersion) throws Exception{

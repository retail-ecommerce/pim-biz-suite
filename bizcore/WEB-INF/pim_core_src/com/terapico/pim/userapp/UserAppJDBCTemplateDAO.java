...
public class UserAppJDBCTemplateDAO extends PimNamingServiceDAO implements UserAppDAO{
	...
	*/
    ...
    public SmartList<UserApp> requestCandidateUserAppForListAccess(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<UserApp> requestCandidateUserAppForObjectAccess(PimUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(UserAppTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getUserAppMapper());
    }
